...
class DistributionTrackRequest {
  ...
  final DistributionTrackRequestStatusEnum status;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is DistributionTrackRequest &&
  ...
  factory DistributionTrackRequest.fromJson(Map<String, dynamic> json) => _$DistributionTrackRequestFromJson(json);
