...
class AdminRequest {
  ...
  AdminRequest({required this.email, required this.password, this.roles});
  ...
  bool operator ==(Object other) =>
      ...
      other is AdminRequest &&
          other.email == email &&
          other.password == password &&
          other.roles == roles;

  @override
  int get hashCode => email.hashCode + password.hashCode + roles.hashCode;
