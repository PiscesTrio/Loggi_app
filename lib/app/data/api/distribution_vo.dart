...
class DistributionVo {
  ...
  final DateTime? createAt;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is DistributionVo &&
      other.id == id &&
      other.driver == driver &&
  ...
  factory DistributionVo.fromJson(Map<String, dynamic> json) => _$DistributionVoFromJson(json);
